# Cursor project rules (메인 PC worktree)
...
## User Rules에 추가 권장 (Cursor Settings → Rules)

```
- 답변은 항상 한국어.
- workspace 경로 확인 후 그 폴더만 수정.
- 모바일(welcome-mo)은 모바일 worktree에서만; PC worktree에서는 금지.
```
